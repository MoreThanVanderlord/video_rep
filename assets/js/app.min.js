...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function($) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = pageHeader;\n\nvar _bodyScrollLock = __webpack_require__(/*! body-scroll-lock */ \"./node_modules/body-scroll-lock/lib/bodyScrollLock.esm.js\");\n\nfunction pageHeader() {\n  var burgerMenu = document.querySelector('.js-burger') || null;\n  var main = document.querySelector('.page_content');\n  var menu = document.querySelector('.pageHeader_menu');\n  var header = document.querySelector('.pageHeader');\n  var headerIsActive = false;\n\n  if (burgerMenu !== null) {\n    burgerMenu.addEventListener('click', function () {\n      this.classList.toggle('pageHeader_menuBtn--active');\n      main.classList.toggle('page_content--active');\n      menu.classList.toggle('pageHeader_menu--active');\n      header.classList.toggle('active');\n      headerIsActive = !headerIsActive;\n\n      if (headerIsActive) {\n        (0, _bodyScrollLock.disableBodyScroll)(header);\n      } else {\n        (0, _bodyScrollLock.enableBodyScroll)(header);\n      }\n    });\n  }\n\n  var lastWindowOffset = 0;\n  window.addEventListener('scroll', function () {\n    var newWindowOffset = window.pageYOffset;\n\n    if (lastWindowOffset > newWindowOffset && $('.pageMain').length === 0 && $(window).width() >= 960) {\n      $('.pageHeader').addClass('fixed');\n    } else {\n      $('.pageHeader').removeClass('fixed');\n    }\n  });\n  setInterval(function () {\n    lastWindowOffset = window.pageYOffset;\n  }, 300);\n}\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\")))\n\n//# sourceURL=webpack:///./src/components/common/pageHeader/pageHeader.js?");

/***/ }),

/***/ "./src/components/common/returnButton/returnButton.js":
/*!************************************************************!*\
  !*** ./src/components/common/returnButton/returnButton.js ***!
  \************************************************************/
/*! no static exports found */
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function($) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = returnButton;\n\nfunction returnButton() {\n  $('.returnButton').on('click', function () {\n    $(\"html, body\").animate({\n      scrollTop: 0\n    }, \"slow\");\n  });\n  $(window).on('scroll', function () {\n    if ($(document).scrollTop() > 1000) {\n      $('.returnButton').fadeIn();\n    } else {\n      $('.returnButton').fadeOut();\n    }\n  });\n}\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\")))\n\n//# sourceURL=webpack:///./src/components/common/returnButton/returnButton.js?");

/***/ }),

/***/ "./src/components/common/share/share.js":
/*!**********************************************!*\
  !*** ./src/components/common/share/share.js ***!
  \**********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = share;\n\nvar _jquery = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\nvar _jquery2 = _interopRequireDefault(_jquery);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction share() {\n  var url = (0, _jquery2.default)('meta[name=\"og:url\"]').attr('content');\n  var title = (0, _jquery2.default)('meta[name=\"og:title\"]').attr('content');\n  var image = (0, _jquery2.default)('meta[name=\"og:image\"]').attr('content');\n  var description = (0, _jquery2.default)('meta[name=\"og:description\"]').attr('content');\n  var fb_appid = (0, _jquery2.default)('meta[name=\"fb:app_id\"]').attr('content');\n  var container = (0, _jquery2.default)('.pageNewsItem_links, .share_list');\n  var shareButtons = container.find('[data-share]');\n  if (!container.length) return;\n  var buttons = [];\n\n  _jquery2.default.each(shareButtons, function (i, e) {\n    var obj = {};\n    var element = (0, _jquery2.default)(e);\n    obj.type = element.data('share');\n    obj.element = element;\n    buttons[obj.type] = obj;\n  });\n  /**\r\n   * vk section\r\n   */\n\n\n  console.log(url ? url : document.location.origin);\n\n  if (typeof buttons['vk'] != \"undefined\") {\n    buttons['vk'].element[0].innerHTML = VK.Share.button({\n      url: url ? url : document.location.origin,\n      title: title ? title : '',\n      image: image ? image : false,\n      noparse: false\n    }, {\n      type: \"custom\",\n      text: \"<a></a>\"\n    });\n  }\n  /**\r\n   * fb section\r\n   */\n\n\n  if (typeof buttons['fb'] != \"undefined\") {\n    (function (d, s, id) {\n      var js,\n          fjs = d.getElementsByTagName(s)[0];\n\n      if (d.getElementById(id)) {\n        return;\n      }\n\n      js = d.createElement(s);\n      js.id = id;\n      js.src = \"https://connect.facebook.net/en_US/sdk.js\";\n      fjs.parentNode.insertBefore(js, fjs);\n    })(document, 'script', 'facebook-jssdk');\n\n    buttons['fb'].element.on('click', function (e) {\n      e.preventDefault();\n      FB.init({\n        appId: fb_appid,\n        status: true,\n        xfbml: true,\n        version: 'v6.0'\n      });\n      FB.ui({\n        method: 'share',\n        href: url ? url : document.location.origin,\n        autoLogAppEvents: true\n      }, function (response) {});\n    });\n  }\n  /**\r\n   * tg section\r\n   */\n\n\n  if (typeof buttons['tg'] != \"undefined\") {\n    var tgString = \"https://telegram.me/share/url?url=\" + encodeURIComponent(url ? url : document.location.origin) + \"&text=\" + encodeURIComponent(title);\n    buttons['tg'].element.attr('href', tgString);\n  }\n  /**\r\n   * tw section\r\n   */\n\n\n  if (typeof buttons['tw'] != \"undefined\") {\n    var twString = \"https://twitter.com/share?url=\" + encodeURIComponent(url ? url : document.location.origin) + \"&text=\" + encodeURIComponent(title);\n    buttons['tw'].element.attr('href', twString);\n  }\n  /**\r\n   * ok section\r\n   */\n\n\n  if (typeof buttons['ok'] != \"undefined\") {\n    var okString = \"https://connect.ok.ru/offer?url=\" + encodeURIComponent(url ? url : document.location.origin) + (\"&title=\" + encodeURIComponent(title)) + (\"&imageUrl=\" + encodeURIComponent(image ? image : false));\n    buttons['ok'].element.attr('href', okString);\n  }\n}\n\n//# sourceURL=webpack:///./src/components/common/share/share.js?");

/***/ }),

/***/ "./src/components/pages/pageAbout/pageAbout.js":
/*!*****************************************************!*\
  !*** ./src/components/pages/pageAbout/pageAbout.js ***!
  \*****************************************************/
/*! no static exports found */
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function($) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = pageAbout;\n\nfunction pageAbout() {\n  var slider = $('.welcome_slider');\n  var windowWidth = $(window).outerWidth();\n\n  var startOwlCarousel = function startOwlCarousel() {\n    slider.owlCarousel({\n      nav: true,\n      dots: false,\n      responsive: {\n        0: {\n          items: 1\n        },\n        768: {\n          items: 2,\n          stagePadding: 26\n        },\n        1024: {\n          items: 2,\n          stagePadding: 50\n        },\n        1100: {\n          items: 2,\n          stagePadding: 90\n        }\n      }\n    });\n  };\n\n  var stopOwlCarousel = function stopOwlCarousel() {\n    slider.trigger('destroy.owl.carousel');\n  };\n\n  if (windowWidth < 1200) {\n    startOwlCarousel();\n  } else {\n    stopOwlCarousel();\n  }\n\n  $(window).on(\"resize\", function (windowWidth) {\n    windowWidth = $(window).outerWidth();\n\n    if (windowWidth < 1200) {\n      startOwlCarousel();\n    } else if (windowWidth >= 1200) {\n      stopOwlCarousel();\n    }\n  });\n  var service = $('.js-service');\n  var activeService = $('.js-service.active');\n  var serviceTitle = $('.pageServices_subtitle');\n  var serviceSubtitle = $('.pageServices_info');\n  var serviceText = $('.pageServices_hidden_text span');\n  var titleDesktop = $('.info_desk_title');\n  var subtitleDesktop = $('.info_desk_subtitle');\n  var textDesktop = $('.info_desk_text');\n  service.on('mouseenter click', function () {\n    service = $('.js-service');\n\n    if ($(window).width() < 1200) {\n      $([document.documentElement, document.body]).animate({\n        scrollTop: $(this).offset().top\n      }, 300);\n    }\n\n    if ($(window).width() < 1200) {\n      service.removeClass('active');\n      $(this).addClass('active');\n    } else {\n      service.removeClass('active');\n      $(this).addClass('active');\n      titleDesktop.text($(this).find(serviceTitle).text());\n      subtitleDesktop.text($(this).find(serviceSubtitle).text());\n      textDesktop.html($(this).find(serviceText).html());\n    }\n  });\n\n  if ($(window).width() >= 1200) {\n    titleDesktop.text(activeService.find(serviceTitle).text());\n    subtitleDesktop.text(activeService.find(serviceSubtitle).text());\n    textDesktop.html(activeService.find(serviceText).html());\n  }\n\n  $(window).on('resize', function () {\n    if ($(window).width() >= 1200) {\n      titleDesktop.text(activeService.find(serviceTitle).text());\n      subtitleDesktop.text(activeService.find(serviceSubtitle).text());\n      textDesktop.html(activeService.find(serviceText).html());\n    }\n  });\n  var awardsSlider = $('.pageAbout_awards_list');\n\n  var startAwardsOwlCarousel = function startAwardsOwlCarousel() {\n    awardsSlider.owlCarousel({\n      nav: true,\n      dots: true,\n      responsive: {\n        0: {\n          items: 1\n        },\n        768: {\n          items: 2,\n          stagePadding: 26\n        },\n        1024: {\n          items: 2,\n          stagePadding: 30\n        },\n        1100: {\n          items: 3,\n          stagePadding: 10\n        }\n      }\n    });\n  };\n\n  var stopAwardsOwlCarousel = function stopAwardsOwlCarousel() {\n    awardsSlider.trigger('destroy.owl.carousel');\n  };\n\n  if (windowWidth < 1200) {\n    startAwardsOwlCarousel();\n  } else {\n    stopAwardsOwlCarousel();\n  }\n\n  $(window).on(\"resize\", function (windowWidth) {\n    windowWidth = $(window).outerWidth();\n\n    if (windowWidth < 1200) {\n      startAwardsOwlCarousel();\n    } else if (windowWidth >= 1200) {\n      stopAwardsOwlCarousel();\n    }\n  });\n}\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\")))\n\n//# sourceURL=webpack:///./src/components/pages/pageAbout/pageAbout.js?");

/***/ }),

/***/ "./src/components/pages/pageContacts/pageContacts.js":
/*!***********************************************************!*\
  !*** ./src/components/pages/pageContacts/pageContacts.js ***!
  \***********************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = pageContacts;\n\nfunction pageContacts() {\n  try {\n    ymaps.ready(function () {\n      var myMap = new ymaps.Map('map', {\n        center: [55.724994, 37.528670],\n        zoom: 4\n      }, {\n        searchControlProvider: 'yandex#search'\n      }),\n          // Создаём макет содержимого.\n      MyIconContentLayout = ymaps.templateLayoutFactory.createClass('<div style=\"color: #FFFFFF; font-weight: bold;\">$[properties.iconContent]</div>'),\n          moscow = new ymaps.Placemark([55.748143, 37.540488], {\n        hintContent: 'Собственный значок метки с контентом',\n        balloonContent: '<strong>Пресненская набережная, 6, стр. 2, Башня \"Имерия-Тауэр\"б 28 этаж</strong>'\n      }, {\n        preset: 'islands#icon',\n        iconColor: '#0095b6'\n      }),\n          saintPetersburg = new ymaps.Placemark([59.955539, 30.354532], {\n        hintContent: 'Собственный значок метки с контентом',\n        balloonContent: '<strong>ул. Комсомола, 41, БЦ \"Финляндский\", 4 этаж</strong>'\n      }, {\n        preset: 'islands#icon',\n        iconColor: '#0095b6'\n      });\n      myMap.geoObjects.add(moscow).add(saintPetersburg);\n      var mscCity = document.getElementById('moscow');\n      var spbCity = document.getElementById('spb');\n      mscCity.addEventListener('click', function () {\n        myMap.panTo([55.748143, 37.540488]);\n      });\n      spbCity.addEventListener('click', function () {\n        myMap.panTo([59.955539, 30.354532]);\n      });\n    });\n  } catch (e) {}\n}\n\n//# sourceURL=webpack:///./src/components/pages/pageContacts/pageContacts.js?");

/***/ }),

/***/ "./src/components/pages/pageMain/pageMain.js":
/*!***************************************************!*\
  !*** ./src/components/pages/pageMain/pageMain.js ***!
  \***************************************************/
/*! no static exports found */
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function($) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = pageMain;\n\nvar _plyrPolyfilled = __webpack_require__(/*! plyr/dist/plyr.polyfilled.min */ \"./node_modules/plyr/dist/plyr.polyfilled.min.mjs\");\n\nvar _plyrPolyfilled2 = _interopRequireDefault(_plyrPolyfilled);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction pageMain() {\n  document.addEventListener('DOMContentLoaded', function () {\n    var player = new _plyrPolyfilled2.default('#video-1', {\n      controls: [''],\n      autoplay: true,\n      loop: {\n        active: true\n      }\n    });\n    var player2 = new _plyrPolyfilled2.default('#video-2', {\n      controls: [''],\n      autoplay: true,\n      loop: {\n        active: true\n      }\n    });\n    var player3 = new _plyrPolyfilled2.default('#video-3', {\n      controls: [''],\n      autoplay: true,\n      loop: {\n        active: true\n      }\n    });\n    var pageMain = $('.pageMain');\n    pageMain.owlCarousel({\n      items: 1,\n      loop: false,\n      nav: false,\n      dots: true,\n      autoplay: true,\n      autoplayTimeout: 5100,\n      mouseDrag: true,\n      touchDrag: true,\n      animateOut: 'mainSlider'\n    });\n    pageMain.on('changed.owl.carousel', function (event) {\n      handleSliderChange(event);\n    });\n\n    function handleSliderChange(event) {\n      pageMain.trigger('stop.owl.autoplay');\n      pageMain.trigger('play.owl.autoplay', 5100);\n\n      if (event) {\n        var index = event.item.index - 1;\n        var count = event.item.count;\n\n        if (index > count) {\n          index -= count;\n        }\n\n        if (index <= 0) {\n          index += count;\n        }\n\n        var current = index;\n\n        if (current === 1) {\n          player.restart();\n          player2.restart();\n        }\n\n        if (current === 2) {\n          player2.restart();\n          player3.restart();\n        }\n\n        if (current === 3) {\n          player3.restart();\n          player.restart();\n        }\n\n        current = '0' + current;\n        $('.pageMain__slider-counter').text(current);\n      }\n    }\n\n    $('.owl-dot').on('click', function () {\n      pageMain.trigger('to.owl.carousel', 1);\n      handleSliderChange();\n    });\n  });\n}\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\")))\n\n//# sourceURL=webpack:///./src/components/pages/pageMain/pageMain.js?");

/***/ }),

/***/ "./src/components/pages/pageNews/pageNews.js":
/*!***************************************************!*\
  !*** ./src/components/pages/pageNews/pageNews.js ***!
  \***************************************************/
/*! no static exports found */
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function($) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = pageNews;\n\nfunction pageNews() {\n  //Первый пост, стрелка серая, следующие розовая\n  var pagination = $('.pageNews__paginationList');\n  var prev = $('.pageNews__paginationBefore');\n  var next = $('.pageNews__paginationAfter');\n  var list = pagination.find('.pageNews__paginationItem');\n\n  if (list.length) {\n    var currentLink = void 0,\n        prevLink = void 0,\n        nextLink = void 0;\n    $.each(list, function (i, e) {\n      if ($(list[i]).hasClass('active')) {\n        currentLink = $(list[i]).attr(\"href\");\n        prevLink = list[i - 1] ? $(list[i - 1]).find('a').attr(\"href\") : false;\n        nextLink = list[i + 1] ? $(list[i + 1]).find('a').attr(\"href\") : false;\n        prevLink ? prev.removeAttr(\"disabled\") : prev.attr(\"disabled\");\n        nextLink ? next.removeAttr(\"disabled\") : next.attr(\"disabled\");\n        prevLink ? prev.attr(\"href\", prevLink) : prev.attr(\"href\", \"#\");\n        nextLink ? next.attr(\"href\", nextLink) : next.attr(\"href\", \"#\");\n      }\n    });\n  } else {\n    prev.attr(\"disabled\", \"disabled\");\n    next.attr(\"disabled\", \"disabled\");\n  }\n}\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\")))\n\n//# sourceURL=webpack:///./src/components/pages/pageNews/pageNews.js?");

/***/ }),

/***/ "./src/components/pages/pageProject/pageProject.js":
/*!*********************************************************!*\
  !*** ./src/components/pages/pageProject/pageProject.js ***!
  \*********************************************************/
/*! no static exports found */
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function($) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = pageProject;\n\nfunction pageProject() {\n  var elems = document.querySelectorAll('.pageProject_video');\n\n  if (elems.length) {\n    var yt = function yt(videoID) {\n      var tag = document.createElement('script');\n      tag.src = \"https://www.youtube.com/iframe_api\";\n      var firstScriptTag = document.getElementsByTagName('script')[0];\n      firstScriptTag.parentNode.insertBefore(tag, firstScriptTag); // 3. This function creates an <iframe> (and YouTube player)\n      //    after the API code downloads.\n\n      var player;\n      var button = void 0;\n      var videoElem = document.querySelector('#player_' + videoID);\n      if (videoElem) button = videoElem.nextElementSibling;\n\n      function onYouTubeIframeAPIReady() {\n        player = new YT.Player('player_' + videoID, {\n          height: '100%',\n          width: '100%',\n          showinfo: '0',\n          videoId: videoID,\n          events: {\n            'onReady': onPlayerReady,\n            'onStateChange': onPlayerStateChange\n          }\n        });\n      }\n\n      window.onYouTubeIframeAPIReady = onYouTubeIframeAPIReady; // 4. The API will call this function when the video player is ready.\n\n      function onPlayerReady(event) {\n        button.addEventListener('click', function (e) {\n          event.target.playVideo();\n          e.target.classList.add('hide');\n        });\n      }\n\n      function onPlayerStateChange(event) {\n        button.classList.add('hide');\n      }\n    };\n\n    var videosIdArray = [];\n\n    for (var i = 0; i < elems.length; i++) {\n      var elem = elems[i];\n      videosIdArray.push(elem.getAttribute(\"data-src\"));\n    }\n\n    videosIdArray.length && videosIdArray.forEach(function (id) {\n      yt(id);\n    });\n  } // js animated counter\n\n\n  var counterElems = document.querySelectorAll('.pageProject_resultTitle');\n  var timeout = 0;\n\n  if (counterElems.length) {\n    var animateCounter = function animateCounter(number, stringBefore, stringAfter, elem) {\n      var target_block = $(\".pageProject_sectionResult\"); // Ищем блок\n\n      var blockStatus = true;\n      $(elem).text(\"--\");\n      onScroll();\n      $(window).scroll(function () {\n        onScroll();\n      });\n\n      function onScroll() {\n        var scrollEvent = $(window).scrollTop() > target_block.position().top - $(window).height();\n\n        if (scrollEvent && blockStatus) {\n          blockStatus = false;\n          setTimeout(function () {\n            $({\n              numberValue: 0\n            }).animate({\n              numberValue: number\n            }, {\n              duration: 1000,\n              easing: \"linear\",\n              step: function step(val) {\n                $(elem).html(stringBefore + Math.ceil(val) + stringAfter);\n              }\n            });\n            console.log(timeout);\n          }, timeout);\n          timeout += 1000;\n        }\n      }\n    };\n\n    for (var _i = 0; _i < counterElems.length; _i++) {\n      var counterText = counterElems[_i].textContent;\n      var numberData = counterText.match(/\\d+/);\n\n      if (numberData) {\n        var number = numberData[0];\n        var position = numberData.index;\n        var stringBefore = counterText.slice(0, position);\n        var stringAfter = counterText.slice(position + number.length);\n        animateCounter(+number, stringBefore, stringAfter, counterElems[_i]);\n      }\n    }\n  }\n}\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\")))\n\n//# sourceURL=webpack:///./src/components/pages/pageProject/pageProject.js?");
...
"use strict";
eval("\n\n__webpack_require__(/*! owl.carousel */ \"./node_modules/owl.carousel/dist/owl.carousel.js\");\n\nvar _jquery = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\nvar _jquery2 = _interopRequireDefault(_jquery);\n\nvar _pageMain = __webpack_require__(/*! ../../components/pages/pageMain/pageMain */ \"./src/components/pages/pageMain/pageMain.js\");\n\nvar _pageMain2 = _interopRequireDefault(_pageMain);\n\nvar _pageAbout = __webpack_require__(/*! ../../components/pages/pageAbout/pageAbout */ \"./src/components/pages/pageAbout/pageAbout.js\");\n\nvar _pageAbout2 = _interopRequireDefault(_pageAbout);\n\nvar _pageContacts = __webpack_require__(/*! ../../components/pages/pageContacts/pageContacts */ \"./src/components/pages/pageContacts/pageContacts.js\");\n\nvar _pageContacts2 = _interopRequireDefault(_pageContacts);\n\nvar _pageHeader = __webpack_require__(/*! ../../components/common/pageHeader/pageHeader */ \"./src/components/common/pageHeader/pageHeader.js\");\n\nvar _pageHeader2 = _interopRequireDefault(_pageHeader);\n\nvar _pageProject = __webpack_require__(/*! ../../components/pages/pageProject/pageProject */ \"./src/components/pages/pageProject/pageProject.js\");\n\nvar _pageProject2 = _interopRequireDefault(_pageProject);\n\nvar _pageNews = __webpack_require__(/*! ../../components/pages/pageNews/pageNews */ \"./src/components/pages/pageNews/pageNews.js\");\n\nvar _pageNews2 = _interopRequireDefault(_pageNews);\n\nvar _share = __webpack_require__(/*! ../../components/common/share/share */ \"./src/components/common/share/share.js\");\n\nvar _share2 = _interopRequireDefault(_share);\n\nvar _returnButton = __webpack_require__(/*! ../../components/common/returnButton/returnButton */ \"./src/components/common/returnButton/returnButton.js\");\n\nvar _returnButton2 = _interopRequireDefault(_returnButton);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n(0, _pageMain2.default)();\n(0, _pageAbout2.default)();\n(0, _pageContacts2.default)();\n(0, _pageHeader2.default)();\n(0, _pageProject2.default)();\n(0, _pageNews2.default)();\n(0, _share2.default)();\n(0, _returnButton2.default)();\n\n//# sourceURL=webpack:///./src/static/js/index.js?");
